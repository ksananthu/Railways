...
def llt_xlsx_writer():
    ...
    # # .....................creating xlsx file................................................................
    workbook = xlsxwriter.Workbook(str(dire) + '\\xlsx\\' + y + '\\llt.xlsx')
    worksheet2 = workbook.add_worksheet('llt')
    ...
    c.execute("select * from llt ORDER BY Date ASC")
    data1 = c.fetchall()

    # # Caption writing
    cap_m_y = str(y).replace('_', ' ').upper()
    caption = 'LOCAL LUGGAGE RETURN OF CALICUT PARCELS FOR THE MONTH OF ' + cap_m_y
    ...
    worksheet2.add_table('A2:H33', {'data': data1,
    ...
    worksheet2.write_formula('H34', '{=SUM(H3:H33)}', cell_format)

    # # .............................Writing extra lines ......................................................
    # # ...........................writing total in words....................................................
    c.execute("select TOTAL from llt ORDER BY Date ASC")
    amount = c.fetchall()
    total_amt = 0
    # print(amount)
    for j in amount:
    ...
    worksheet2.write('H39', 'CPS/CLT', cell_format)

    # .....................................................................
    workbook.close()

    # # opening the file
    webbrowser.open(str(dire) + '\\xlsx\\' + y + '\\llt.xlsx')
    print('\n')
