...
def ll_xlsx_writer():
    ...
    # # .....................creating xlsx file................................................................
    workbook = xlsxwriter.Workbook(str(dire) + '\\xlsx\\' + y + '\\ll.xlsx')
    worksheet2 = workbook.add_worksheet('ll')
    ...
    caption = 'RETURN OF LEFT LUGGAGE AT CLT PLS FOR THE MONTH OF ' + cap_m_y
    ...
    worksheet2.add_table('C3:D35', {'data': data1,
    ...
    worksheet2.write('C36', 'Total', cell_format)
    worksheet2.write_formula('D36', '{=SUM(D4:D35)}', cell_format)

    # # .............................Writing extra lines ......................................................
    # # ...........................writing total in words....................................................
    c.execute("select ll from cashbook ORDER BY Date ASC")
    amount = c.fetchall()
    total_amt = 0
    # print(amount)
    for j in amount:
    ...
    worksheet2.write('A38', in_words)
    worksheet2.write('A42', 'CLT PO', cell_format)
    worksheet2.write('A43', month1, cell_format)
    worksheet2.write('F42', 'CPS/CLT', cell_format)
    ...
    # # opening the file
    webbrowser.open(str(dire) + '\\xlsx\\' + y + '\\ll.xlsx')
    print('\n')
