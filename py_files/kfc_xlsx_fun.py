...
# os.chdir('D:\\pycharm_files\\AccountKFC')
dire = os.getcwd()
...
def kfc_xlsx_writer():
    ...
    # # .....................creating xlsx file................................................................
    workbook = xlsxwriter.Workbook(str(dire) + '\\xlsx\\' + y + '\\kfc.xlsx')
    worksheet2 = workbook.add_worksheet('kfc')
    ...
    caption = 'KFC STATEMENT OF CLT PARCELS FOR THE MONTH OF ' + cap_m_y
    ...
    # ...............lop....................................
    c.execute("select kfc from lop ORDER BY Date ASC")
    amount1 = c.fetchall()
    total_amt1 = 0
    # print(amount)
    for j in amount1:
    ...
    # ...............llt....................................
    c.execute("select kfc from llt ORDER BY Date ASC")
    amount2 = c.fetchall()
    total_amt2 = 0
    # print(amount)
    for j in amount2:
    ...
    # # opening the file
    webbrowser.open(str(dire) + '\\xlsx\\' + y + '\\kfc.xlsx')
    print('\n')
